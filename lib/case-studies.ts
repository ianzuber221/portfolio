...
export const supernovaCaseStudy: CaseStudy = {
  ...
  problem:
    "Hack Reactor's system-design capstone asked each of us to build one backend service of a commercial retail app from scratch. Mine started from a couple of CSV files of raw product data on PostgreSQL, a database I had not used before. The bar was 1,000 requests per second for 30 seconds, under 50ms per request, with under 1% errors. After the first query pass, local responses were 3-15 seconds. That was nowhere near the goal.",
  approach: [
